...
<div class="wrapper">
    <header class="main-header">
        ...
        <a href="index.php" class="logo">
            ...
            <span class="logo-lg">SPC-<strong>Firewall</strong></span>
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <a class="btn-link" href="https://sakthitech.net/" rel="noopener" target="_blank">
                                    <svg class="svg-inline--fa fa-fw menu-icon" style="height: 1.25em"><use xlink:href="img/pihole_icon.svg#pihole-svg-logo"/></svg>
                                    SPC-WEBSITE
                                </a>
                                <hr>
                                <a class="btn-link" href="https://instagram.com/follow_pannuriya_da_body_soda_?igshid=YmMyMTA2M2Y=" rel="noopener" target="_blank"><i class="fa fa-fw menu-icon fa-question-circle"></i> Sudarsan</a>
                                <a class="btn-link" href="https://instagram.com/smiley__anandhi?igshid=YmMyMTA2M2Y=" rel="noopener" target="_blank"><i class="fa fa-fw menu-icon fab fa-discourse"></i> Anandhi</a>
                                <a class="btn-link" href="https://instagram.com/rx_king_nataraj?igshid=YmMyMTA2M2Y=" rel="noopener" target="_blank"><i class="fa-fw menu-icon fab fa-github"></i> Nataraj</a>
                                <a class="btn-link" href="https://instagram.com/attitude_girl_panju?igshid=YmMyMTA2M2Y=" rel="noopener" target="_blank"><i class="fa-fw menu-icon fa fa-regular fa-rocket"></i> Panjavaranam </a>
