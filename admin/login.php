...
<div class="box login-box">
    <section style="padding: 15px;">
        <div class="login-logo">
            ...
            <div class="panel-title text-center"><span class="logo-lg" style="font-size: 25px;">SPC-<b>Firewall</b></span></div>
        </div>
        <!-- /.login-logo -->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box box-<?php if (!$wrongpassword) { ?>info collapsed-box<?php } else { ?>danger<?php }?>">
                            ...
                            <div class="box-body">
                                <p>After installing ) SPC-Firewall for the first time, a password is generated and displayed
